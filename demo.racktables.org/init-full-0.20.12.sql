...
-- ------------------------------------------------------
-- Server version	5.5.54-0+deb7u1-log
...
--
-- ORDER BY:  `object_id`,`server_id`,`graph_id`
...
INSERT INTO `Config` VALUES ('CACTI_RRA_ID','1','uint','no','no','yes','RRA ID for Cacti graphs displayed in RackTables');
...
INSERT INTO `Config` VALUES ('DB_VERSION','0.20.12','string','no','yes','no','Database version.');
...
INSERT INTO `Config` VALUES ('DEFAULT_PORT_OIF_IDS','1=24; 3=1078; 4=1077; 5=1079; 6=1080; 8=1082; 9=1084; 10=1588; 11=1668; 12=1589; 13=1590; 14=1591; 15=1588','string','no','no','no','Default port outer interface IDs');
...
INSERT INTO `Dictionary` VALUES (12,2176,'yes','HP ProCurve%GPASS%1910-24G');
...
INSERT INTO `Dictionary` VALUES (12,2214,'yes','[[Edge-Core%GPASS%AS6700-32X | http://www.edge-core.com/ProdDtl.asp?sno=435&AS6700-32X%20with%20ONIE]]');
INSERT INTO `Dictionary` VALUES (12,2215,'yes','[[Edge-Core%GPASS%AS6701-32X | http://www.edge-core.com/ProdDtl.asp?sno=435&AS6700-32X%20with%20ONIE]]');
INSERT INTO `Dictionary` VALUES (12,2216,'yes','[[Edge-Core%GPASS%AS5610-52X | http://www.edge-core.com/ProdDtl.asp?sno=436&AS5610-52X%20with%20ONIE]]');
INSERT INTO `Dictionary` VALUES (12,2217,'yes','[[Edge-Core%GPASS%AS5600-52X | http://www.edge-core.com/ProdDtl.asp?sno=423&AS5600-52X%20with%20ONIE]]');
INSERT INTO `Dictionary` VALUES (12,2218,'yes','[[Edge-Core%GPASS%AS4600-54T | http://www.edge-core.com/ProdDtl.asp?sno=425&AS4600-54T%20with%20ONIE]]');
...
INSERT INTO `Dictionary` VALUES (12,2238,'yes','HP ProCurve%GPASS%1910-48G');
...
INSERT INTO `Dictionary` VALUES (12,2242,'yes','HP ProCurve%GPASS%1810G-24');
...
INSERT INTO `Dictionary` VALUES (18,2460,'yes','NetApp%GPASS%FAS2552');
...
INSERT INTO `Dictionary` VALUES (24,2574,'yes','Cisco%GPASS%ASR 920');
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE TRIGGER `Port-before-insert` BEFORE INSERT ON `Port` FOR EACH ROW PortTrigger:BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE TRIGGER `Port-before-update` BEFORE UPDATE ON `Port` FOR EACH ROW PortTrigger:BEGIN
  IF (NEW.`l2address` IS NOT NULL AND (SELECT COUNT(*) FROM `Port` WHERE `l2address` = NEW.`l2address` AND `object_id` != NEW.`object_id`) > 0) THEN
    CALL `Port-l2address-already-exists-on-another-object`;
  END IF;
END */;;
...
-- Dump completed on 2017-02-15 12:37:59
