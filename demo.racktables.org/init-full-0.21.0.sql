...
INSERT INTO `Config` VALUES ('DB_VERSION','0.21.0','string','no','yes','no','Database version.');
...
INSERT INTO `Config` VALUES ('VLANNET_LISTSRC','','string','yes','no','yes','List of VLAN-based IPv4 networks');
