...
INSERT INTO `Config` VALUES ('DB_VERSION','0.20.4','string','no','yes','no','Database version.');
...
INSERT INTO `Config` VALUES ('IPV4OBJ_LISTSRC','{$typeid_4} or {$typeid_7} or {$typeid_8} or {$typeid_12} or {$typeid_445} or {$typeid_447} or {$typeid_798} or {$typeid_965} or {$typeid_1397} or {$typeid_1502} or {$typeid_1503} or {$typeid_1504} or {$typeid_1507} or {$typeid_1787}','string','yes','no','no','List source: IPv4-enabled objects');
...
INSERT INTO `Dictionary` VALUES (31,1822,'yes','[[Fujitsu%GSKIP%PRIMERGY BX400 S1 | http://www.fujitsu.com/fts/products/computing/servers/primergy/blades/bx400/index.html]]');
INSERT INTO `Dictionary` VALUES (31,1823,'yes','[[Fujitsu%GSKIP%PRIMERGY BX900 S2 | http://www.fujitsu.com/fts/products/computing/servers/primergy/blades/bx900s2/index.html]]');
...
-- Dump completed on 2013-04-15  0:43:23
