-- MySQL dump 10.13  Distrib 5.1.61, for portbld-freebsd8.2 (amd64)
--
-- Host: localhost    Database: rt_test
-- ------------------------------------------------------
...
INSERT INTO `Config` VALUES ('DB_VERSION','0.20.3','string','no','yes','no','Database version.');
...
-- Dump completed on 2012-12-19 22:05:53
